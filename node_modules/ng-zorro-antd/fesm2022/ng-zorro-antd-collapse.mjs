...
import { inject, ChangeDetectorRef, booleanAttribute, Input, ViewEncapsulation, ChangeDetectionStrategy, Component, NgZone, DestroyRef, input, output, linkedSignal, viewChild, ElementRef, NgModule } from '@angular/core';
...
let NzCollapseComponent = (() => {
    ...
    return class NzCollapseComponent {
        ...
        static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: NzCollapseComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
        static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "16.1.0", version: "21.0.0", type: NzCollapseComponent, isStandalone: true, selector: "nz-collapse", inputs: { nzAccordion: ["nzAccordion", "nzAccordion", booleanAttribute], nzBordered: ["nzBordered", "nzBordered", booleanAttribute], nzGhost: ["nzGhost", "nzGhost", booleanAttribute], nzExpandIconPosition: "nzExpandIconPosition", nzSize: "nzSize" }, host: { properties: { "class.ant-collapse-icon-position-start": "nzExpandIconPosition === 'start'", "class.ant-collapse-icon-position-end": "nzExpandIconPosition === 'end'", "class.ant-collapse-ghost": "nzGhost", "class.ant-collapse-borderless": "!nzBordered", "class.ant-collapse-rtl": "dir() === 'rtl'", "class.ant-collapse-small": "nzSize === 'small'", "class.ant-collapse-large": "nzSize === 'large'" }, classAttribute: "ant-collapse" }, exportAs: ["nzCollapse"], ngImport: i0, template: `<ng-content></ng-content>`, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
    };
})();
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: NzCollapseComponent, decorators: [{
            type: Component,
            args: [{
...
let NzCollapsePanelComponent = (() => {
    ...
    return class NzCollapsePanelComponent {
        ...
        nzActive = input(false, ...(ngDevMode ? [{ debugName: "nzActive", transform: booleanAttribute }] : [{ transform: booleanAttribute }]));
        /**
         ...
         */
        active = linkedSignal(() => this.nzActive(), ...(ngDevMode ? [{ debugName: "active" }] : []));
        collapseHeader = viewChild.required('collapseHeader', { read: ElementRef });
        collapseIcon = viewChild('collapseIcon', ...(ngDevMode ? [{ debugName: "collapseIcon", read: ElementRef }] : [{ read: ElementRef }]));
        constructor() {
        ...
        ngAfterViewInit() {
            ...
            const element = this.nzShowArrow && this.nzCollapsible === 'icon' && icon
                ? icon.nativeElement
        ...
        static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: NzCollapsePanelComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
        static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.0.0", type: NzCollapsePanelComponent, isStandalone: true, selector: "nz-collapse-panel", inputs: { nzActive: { classPropertyName: "nzActive", publicName: "nzActive", isSignal: true, isRequired: false, transformFunction: null }, nzDisabled: { classPropertyName: "nzDisabled", publicName: "nzDisabled", isSignal: false, isRequired: false, transformFunction: booleanAttribute }, nzShowArrow: { classPropertyName: "nzShowArrow", publicName: "nzShowArrow", isSignal: false, isRequired: false, transformFunction: booleanAttribute }, nzExtra: { classPropertyName: "nzExtra", publicName: "nzExtra", isSignal: false, isRequired: false, transformFunction: null }, nzHeader: { classPropertyName: "nzHeader", publicName: "nzHeader", isSignal: false, isRequired: false, transformFunction: null }, nzExpandedIcon: { classPropertyName: "nzExpandedIcon", publicName: "nzExpandedIcon", isSignal: false, isRequired: false, transformFunction: null }, nzCollapsible: { classPropertyName: "nzCollapsible", publicName: "nzCollapsible", isSignal: false, isRequired: false, transformFunction: null } }, outputs: { nzActiveChange: "nzActiveChange" }, host: { properties: { "class.ant-collapse-no-arrow": "!nzShowArrow", "class.ant-collapse-item-active": "active()", "class.ant-collapse-item-disabled": "nzDisabled || nzCollapsible === \"disabled\"" }, classAttribute: "ant-collapse-item" }, viewQueries: [{ propertyName: "collapseHeader", first: true, predicate: ["collapseHeader"], descendants: true, read: ElementRef, isSignal: true }, { propertyName: "collapseIcon", first: true, predicate: ["collapseIcon"], descendants: true, read: ElementRef, isSignal: true }], exportAs: ["nzCollapsePanel"], ngImport: i0, template: `
    <div
      #collapseHeader
      role="button"
  ...
  `, isInline: true, dependencies: [{ kind: "ngmodule", type: NzOutletModule }, { kind: "directive", type: i1.NzStringTemplateOutletDirective, selector: "[nzStringTemplateOutlet]", inputs: ["nzStringTemplateOutletContext", "nzStringTemplateOutlet"], exportAs: ["nzStringTemplateOutlet"] }, { kind: "ngmodule", type: NzIconModule }, { kind: "directive", type: i2.NzIconDirective, selector: "nz-icon,[nz-icon]", inputs: ["nzSpin", "nzRotate", "nzType", "nzTheme", "nzTwotoneColor", "nzIconfont"], exportAs: ["nzIcon"] }, { kind: "directive", type: NzAnimationCollapseDirective, selector: "[animation-collapse]", inputs: ["open", "leavedClassName"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
    };
})();
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: NzCollapsePanelComponent, decorators: [{
            type: Component,
            args: [{
  ...
  `,
        ...
        }], ctorParameters: () => [], propDecorators: { nzActive: [{ type: i0.Input, args: [{ isSignal: true, alias: "nzActive", required: false }] }], nzDisabled: [{
                type: Input,
                args: [{ transform: booleanAttribute }]
            }], nzShowArrow: [{
                type: Input,
                ...
                type: Input
            }], nzActiveChange: [{ type: i0.Output, args: ["nzActiveChange"] }], collapseHeader: [{ type: i0.ViewChild, args: ['collapseHeader', { ...{ read: ElementRef }, isSignal: true }] }], collapseIcon: [{ type: i0.ViewChild, args: ['collapseIcon', { ...{ read: ElementRef }, isSignal: true }] }] } });
...
class NzCollapseModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: NzCollapseModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.0.0", ngImport: i0, type: NzCollapseModule, imports: [NzCollapsePanelComponent, NzCollapseComponent], exports: [NzCollapsePanelComponent, NzCollapseComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: NzCollapseModule, imports: [NzCollapsePanelComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: NzCollapseModule, decorators: [{
            type: NgModule,
            args: [{
